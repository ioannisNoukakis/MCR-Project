...
public class ClientHandler extends Thread {
    ...
    public ClientHandler(HyperMediator mediator, Socket socket) throws IOException {
        ...
        sender = new Sender(socket.getInetAddress().getHostAddress(), socket.getLocalPort()+1);
        //sender = new Sender("localhost", 8001);
    }
    ...
    /**
     * Sends an object to the client with UDP
     * @param o The object to send
     */
    public void sendUDPdatagram(Object o)
    {
        try {
            // send object
            sender.sendTo(o);
